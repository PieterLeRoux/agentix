...
const FunctionCard = ({ functionName, theme }: { functionName: string; theme: Theme }) => {
...
export function DelegatesNodeComponent(props: NodeComponentProps) {
    ...
    <div className={styles} data-testid="node" onClick={handleClick}>
      ...
      <div className="content">
        ...
        <div className="functions-grid">
          {functions.map((functionName: string, index: number) => (
            <FunctionCard 
              key={index}
