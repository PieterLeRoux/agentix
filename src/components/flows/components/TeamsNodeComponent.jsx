...
import { useTheme, Box, Paper, Tooltip } from '@mui/material';
...
const AgentCard = ({ agent, isLeader, theme }) => {
...
export function TeamsNodeComponent(props) {
  ...
  const { id, label, agents = [], goal = null, result = null } = data;
