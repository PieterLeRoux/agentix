...
import { useTheme, Box, Tooltip, IconButton, Typography, Theme } from '@mui/material';
import { Presets } from 'rete-react-plugin';
import { NodeComponentProps, WorkflowData } from '../../../types/workflow';
...
const WorkflowPreview = ({ workflow, theme }: { workflow: WorkflowData | undefined; theme: Theme }) => {
...
export function SubFlowsNodeComponent(props: NodeComponentProps) {
  const { data, emit, onNodeClick } = props;
  ...
  const handleLaunchWorkflow = (e: React.MouseEvent) => {
    e.stopPropagation();
